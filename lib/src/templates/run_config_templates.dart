const runConfigDevelopmentTemplate =
    '<component name="ProjectRunConfigurationManager">\n'
    '  <configuration default="false" name="development" '
...
const runConfigStagingTemplate =
    '<component name="ProjectRunConfigurationManager">\n'
    '  <configuration default="false" name="staging" '
    'type="FlutterRunConfigurationType" factoryName="Flutter">\n'
...
const runConfigProductionTemplate =
    '<component name="ProjectRunConfigurationManager">\n'
    '  <configuration default="false" name="production" '
    'type="FlutterRunConfigurationType" factoryName="Flutter">\n'
